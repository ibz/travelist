...
{var p=point_data[i];var visit_count_text="visited "+p.visit_count+" time"+(p.visit_count==1?"":"s");var marker=new GMarker(new GLatLng(p.lat,p.lng),{title:p.name+", "+visit_count_text,icon:G_DEFAULT_ICON});markers.push(marker);}
