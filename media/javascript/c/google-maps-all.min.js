...
{if(!GBrowserIsCompatible())
{return;}
var initialZoom=9;var map=new GMap2(document.getElementById('map'));map.addControl(new GLargeMapControl());map.setCenter(new GLatLng(0,0),initialZoom);centerMap(map,point_data);var markers=[];for(var i=0;i<point_data.length;i++)
...
var marker=new GMarker(new GLatLng(p.lat,p.lng),{title:p.name+", "+visit_count_text+", "+rating_text,icon:icon});markers.push(marker);}
